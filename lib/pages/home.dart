...
class _HomeState extends State<Home> {
  ...
  @override
  void dispose() {
    _homeBloc.dispose(); // closes all of the StreamControllers
    super.dispose();
  }

  // method to add or edit a journal entry and show the entry dialog
  ...
  // method to display confirmation when deleting an entry
