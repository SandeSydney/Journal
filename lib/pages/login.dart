...
class _LoginState extends State<Login> {
  ...
  void initState() {
    ...
    // initialised from here since LoginBloc does not have a provider
  }

  @override
  void dispose() {
    _loginBloc.dispose(); // closes all of the StreamControllers
    super.dispose();
  }
  ...
  // method to build login and create buttons
  ...
  // returns Login button first before Create Account
  // Login button default, hence RaisedButton widget
  ...
  // Combination with the Create Accounts first then Login
  // Create Button the default here
